...
const FeeHistory = () => {
    ...
    const loadFeeHistory = async () => {
        ...
        try {
            ...
            const data = await (0, feeHistoryService_1.getHistoriesFromApi)(historyFilter);
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", sx: { mb: 3 }, children: "\u6703\u8CBB\u6B77\u53F2\u8A18\u9304" }), (0, jsx_runtime_1.jsx)(material_1.Paper, { sx: { p: 2, mb: 3 }, children: (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, spacing: 2, alignItems: "center", children: [(0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, sm: 3, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u6703\u54E1\u7DE8\u865F/\u59D3\u540D", name: "userId", value: filter.userId, onChange: handleTextChange, size: "small" }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, sm: 3, children: (0, jsx_runtime_1.jsxs)(material_1.FormControl, { fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u6536\u6B3E\u72C0\u614B" }), (0, jsx_runtime_1.jsx)(material_1.Select, { name: "status", value: filter.status || '', onChange: handleStatusChange, label: "\u6536\u6B3E\u72C0\u614B", size: "small", children: statusOptions.map(option => ((0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: option.value, children: option.label }, option.value))) })] }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, sm: 2, children: (0, jsx_runtime_1.jsx)(DatePicker_1.DatePicker, { label: "\u8D77\u59CB\u65E5\u671F", value: dateRange.startDate, onChange: handleDateChange('startDate'), slotProps: { textField: { fullWidth: true, size: 'small' } } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, sm: 2, children: (0, jsx_runtime_1.jsx)(DatePicker_1.DatePicker, { label: "\u7D50\u675F\u65E5\u671F", value: dateRange.endDate, onChange: handleDateChange('endDate'), slotProps: { textField: { fullWidth: true, size: 'small' } } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, sm: 2, children: (0, jsx_runtime_1.jsx)(material_1.Button, { fullWidth: true, variant: "contained", startIcon: (0, jsx_runtime_1.jsx)(icons_material_1.Download, {}), onClick: handleExport, children: "\u532F\u51FA\u5831\u8868" }) })] }) }), (0, jsx_runtime_1.jsx)(material_1.TableContainer, { component: material_1.Paper, children: (0, jsx_runtime_1.jsxs)(material_1.Table, { children: [(0, jsx_runtime_1.jsx)(material_1.TableHead, { children: (0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'userId' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'userId', direction: orderBy === 'userId' ? order : 'asc', onClick: () => handleSort('userId'), children: "\u6703\u54E1\u7DE8\u865F" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'userName' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'userName', direction: orderBy === 'userName' ? order : 'asc', onClick: () => handleSort('userName'), children: "\u59D3\u540D" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'memberType' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'memberType', direction: orderBy === 'memberType' ? order : 'asc', onClick: () => handleSort('memberType'), children: "\u6703\u54E1\u985E\u578B" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", sortDirection: orderBy === 'amount' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'amount', direction: orderBy === 'amount' ? order : 'asc', onClick: () => handleSort('amount'), children: "\u91D1\u984D" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'dueDate' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'dueDate', direction: orderBy === 'dueDate' ? order : 'asc', onClick: () => handleSort('dueDate'), children: "\u5230\u671F\u65E5" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'paymentDate' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'paymentDate', direction: orderBy === 'paymentDate' ? order : 'asc', onClick: () => handleSort('paymentDate'), children: "\u7E73\u8CBB\u65E5\u671F" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'paymentMethod' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'paymentMethod', direction: orderBy === 'paymentMethod' ? order : 'asc', onClick: () => handleSort('paymentMethod'), children: "\u7E73\u8CBB\u65B9\u5F0F" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'status' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'status', direction: orderBy === 'status' ? order : 'asc', onClick: () => handleSort('status'), children: "\u72C0\u614B" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { sortDirection: orderBy === 'note' ? order : false, children: (0, jsx_runtime_1.jsx)(material_1.TableSortLabel, { active: orderBy === 'note', direction: orderBy === 'note' ? order : 'asc', onClick: () => handleSort('note'), children: "\u5099\u8A3B" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u64CD\u4F5C" })] }) }), (0, jsx_runtime_1.jsx)(material_1.TableBody, { children: sortedHistories.length === 0 ? ((0, jsx_runtime_1.jsx)(material_1.TableRow, { children: (0, jsx_runtime_1.jsx)(material_1.TableCell, { colSpan: 11, align: "center", children: "\u76EE\u524D\u6C92\u6709\u7B26\u5408\u689D\u4EF6\u7684\u6B77\u53F2\u8A18\u9304" }) })) : (sortedHistories.map((record) => ((0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.userId }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.userName }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.memberType }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: (0, numberUtils_1.formatCurrency)(record.amount) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: (0, dateUtils_1.formatDate)(record.dueDate) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.paymentDate ? (0, dateUtils_1.formatDate)(record.paymentDate) : '-' }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.paymentMethod || '-' }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getStatusChip(record.status) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: record.note || '-' }), (0, jsx_runtime_1.jsxs)(material_1.TableCell, { children: [(0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u7DE8\u8F2F", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", onClick: () => handleEditClick(record), children: (0, jsx_runtime_1.jsx)(icons_material_1.Edit, {}) }) }), (0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u522A\u9664", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", onClick: () => handleDeleteClick(record), color: "error", children: (0, jsx_runtime_1.jsx)(icons_material_1.Delete, {}) }) })] })] }, record.id)))) })] }) }), (0, jsx_runtime_1.jsxs)(material_1.Dialog, { open: !!editingRecord, onClose: () => setEditingRecord(null), maxWidth: "md", fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.DialogTitle, { children: "\u7DE8\u8F2F\u6B77\u53F2\u8A18\u9304" }), (0, jsx_runtime_1.jsx)(material_1.DialogContent, { children: (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, spacing: 2, sx: { pt: 2 }, children: [(0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u6703\u54E1\u7DE8\u865F", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.userId) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u59D3\u540D", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.userName) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u6703\u54E1\u985E\u578B", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.memberType) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u91D1\u984D", type: "number", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.amount) || '', onChange: (e) => handleFieldChange('amount', Number(e.target.value)) }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u5230\u671F\u65E5", type: "date", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.dueDate) || '', onChange: (e) => handleFieldChange('dueDate', e.target.value), InputLabelProps: { shrink: true } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u7E73\u8CBB\u65E5\u671F", type: "date", value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.paymentDate) || '', onChange: (e) => handleFieldChange('paymentDate', e.target.value), InputLabelProps: { shrink: true } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsxs)(material_1.FormControl, { fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u72C0\u614B" }), (0, jsx_runtime_1.jsxs)(material_1.Select, { value: (editingRecord === null || editingRecord === void 0 ? void 0 : editingRecord.status) || '', onChange: (e) => {
                                                    const value = e.target.value;
