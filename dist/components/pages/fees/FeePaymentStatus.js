...
const FeePaymentStatus = () => {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { mb: 3, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { display: 'flex', gap: 2, alignItems: 'center' }, children: [(0, jsx_runtime_1.jsxs)(material_1.FormControl, { size: "small", sx: { minWidth: 120 }, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u72C0\u614B\u7BE9\u9078" }), (0, jsx_runtime_1.jsxs)(material_1.Select, { value: filter.status, onChange: (e) => handleFilterChange('status', e.target.value), label: "\u72C0\u614B\u7BE9\u9078", children: [(0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "", children: "\u5168\u90E8" }), (0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "\u5F85\u6536\u6B3E", children: "\u5F85\u6536\u6B3E" }), (0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "\u5DF2\u6536\u6B3E", children: "\u5DF2\u6536\u6B3E" }), (0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "\u903E\u671F", children: "\u903E\u671F" }), (0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "\u7D42\u6B62", children: "\u7D42\u6B62" })] })] }), (0, jsx_runtime_1.jsxs)(material_1.FormControl, { size: "small", sx: { minWidth: 120 }, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u6703\u54E1\u985E\u578B" }), (0, jsx_runtime_1.jsxs)(material_1.Select, { value: filter.memberType, onChange: (e) => handleFilterChange('memberType', e.target.value), label: "\u6703\u54E1\u985E\u578B", children: [(0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "", children: "\u5168\u90E8" }), memberTypes.map(type => ((0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: type, children: type }, type)))] })] })] }), (0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { display: 'flex', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsx)(material_1.Button, { variant: "contained", startIcon: (0, jsx_runtime_1.jsx)(icons_material_1.Add, {}), onClick: () => setCreateAnnualOpen(true), sx: { mr: 2 }, children: "\u7522\u751F\u5E74\u5EA6\u61C9\u6536" }), (0, jsx_runtime_1.jsx)(material_1.TextField, { size: "small", placeholder: "\u641C\u5C0B\u6703\u54E1\u7DE8\u865F\u6216\u59D3\u540D", value: filter.search, onChange: (e) => handleFilterChange('search', e.target.value), InputProps: {
                                ...
                                var _a, _b, _c;
                                return ((0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payment.memberId }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payment.memberName }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payment.memberType }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: (_c = (_b = (_a = payment.amount) === null || _a === void 0 ? void 0 : _a.toLocaleString) === null || _b === void 0 ? void 0 : _b.call(_a)) !== null && _c !== void 0 ? _c : payment.amount }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: formatDate(payment.dueDate) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: formatDate(payment.paidDate) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getPaymentMethodLabel(payment.paymentMethod) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getStatusChip(payment.status) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payment.note || '-' }), (0, jsx_runtime_1.jsxs)(material_1.TableCell, { children: [(0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u7DE8\u8F2F", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", onClick: () => handleEditClick(payment), children: (0, jsx_runtime_1.jsx)(icons_material_1.Edit, {}) }) }), (0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u522A\u9664", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", onClick: () => handleDeleteClick(payment), color: "error", children: (0, jsx_runtime_1.jsx)(icons_material_1.Delete, {}) }) })] })] }, payment.id));
                            }) })] }) }), (0, jsx_runtime_1.jsxs)(material_1.Dialog, { open: !!editingPayment, onClose: () => setEditingPayment(null), maxWidth: "md", fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.DialogTitle, { children: "\u7DE8\u8F2F\u6536\u6B3E\u8CC7\u8A0A" }), (0, jsx_runtime_1.jsx)(material_1.DialogContent, { children: (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, spacing: 2, sx: { pt: 2 }, children: [(0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u6703\u54E1\u7DE8\u865F", name: "memberId", value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.memberId) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u59D3\u540D", name: "memberName", value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.memberName) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u6703\u54E1\u985E\u578B", name: "memberType", value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.memberType) || '', disabled: true }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u91D1\u984D", name: "amount", type: "number", value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.amount) || '', onChange: (e) => handleFieldChange('amount', e.target.value) }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u5230\u671F\u65E5", name: "dueDate", type: "date", value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.dueDate) || '', onChange: (e) => handleFieldChange('dueDate', e.target.value), InputLabelProps: { shrink: true } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 6, children: (0, jsx_runtime_1.jsxs)(material_1.FormControl, { fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u72C0\u614B" }), (0, jsx_runtime_1.jsxs)(material_1.Select, { value: (editingPayment === null || editingPayment === void 0 ? void 0 : editingPayment.status) || '', onChange: (e) => {
                                                    if (editingPayment) {
