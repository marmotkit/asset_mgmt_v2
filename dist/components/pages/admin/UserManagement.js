...
const UserManagement = () => {
    ...
    const [viewPwdDialogOpen, setViewPwdDialogOpen] = (0, react_1.useState)(false);
    const [viewPwdUser, setViewPwdUser] = (0, react_1.useState)(null);
    const [viewPwd, setViewPwd] = (0, react_1.useState)('');
    const [viewPwdLoading, setViewPwdLoading] = (0, react_1.useState)(false);
    ...
    const handleViewPwd = async () => {
        ...
        try {
            ...
            const password = await userService_1.userService.getUserPassword(viewPwdUser.id);
            setViewPwd(password);
        }
        catch (err) {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { display: "flex", justifyContent: "space-between", alignItems: "center", mb: 3, children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h5", children: "\u6703\u54E1\u7BA1\u7406" }), (0, jsx_runtime_1.jsx)(material_1.Button, { variant: "contained", startIcon: (0, jsx_runtime_1.jsx)(icons_material_1.Add, {}), onClick: handleAddUser, children: "\u65B0\u589E\u6703\u54E1" })] }), error && ((0, jsx_runtime_1.jsx)(material_1.Alert, { severity: "error", sx: { mb: 3 }, children: error })), (0, jsx_runtime_1.jsx)(material_1.TableContainer, { component: material_1.Paper, children: (0, jsx_runtime_1.jsxs)(material_1.Table, { children: [(0, jsx_runtime_1.jsx)(material_1.TableHead, { children: (0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u6703\u54E1\u7DE8\u865F" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u5E33\u865F" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u59D3\u540D" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u96FB\u5B50\u90F5\u4EF6" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u89D2\u8272" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u6240\u5C6C\u516C\u53F8" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u72C0\u614B" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u64CD\u4F5C" })] }) }), (0, jsx_runtime_1.jsxs)(material_1.TableBody, { children: [filteredUsers.map((user) => ((0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: user.memberNo }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: user.username }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: user.name }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: user.email }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: (0, jsx_runtime_1.jsx)(material_1.Chip, { label: getRoleLabel(user.role), color: getRoleColor(user.role), size: "small" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getCompanyName(user.companyId) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: (0, jsx_runtime_1.jsx)(material_1.Chip, { label: getStatusLabel(user.status), color: user.status === 'active' ? 'success' : 'error', size: "small" }) }), (0, jsx_runtime_1.jsxs)(material_1.TableCell, { children: [(0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u7DE8\u8F2F", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", onClick: () => handleEditUser(user), children: (0, jsx_runtime_1.jsx)(icons_material_1.Edit, {}) }) }), (0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u91CD\u8A2D\u5BC6\u78BC", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", color: "primary", onClick: () => handleOpenResetPwd(user), children: (0, jsx_runtime_1.jsx)(LockReset_1.default, {}) }) }), (0, jsx_runtime_1.jsx)(material_1.Tooltip, { title: "\u67E5\u8A62\u5BC6\u78BC", children: (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", color: "secondary", onClick: () => handleOpenViewPwd(user), children: (0, jsx_runtime_1.jsx)(Visibility_1.default, {}) }) })] })] }, user.id))), filteredUsers.length === 0 && ((0, jsx_runtime_1.jsx)(material_1.TableRow, { children: (0, jsx_runtime_1.jsx)(material_1.TableCell, { colSpan: 8, align: "center", children: "\u5C1A\u7121\u6703\u54E1\u8CC7\u6599" }) }))] })] }) }), (0, jsx_runtime_1.jsx)(UserDetailDialog_1.default, { open: isDialogOpen, onClose: handleCloseDialog, onSave: handleSaveUser, user: selectedUser }), (0, jsx_runtime_1.jsxs)(Dialog_1.default, { open: resetPwdDialogOpen, onClose: handleCloseResetPwd, children: [(0, jsx_runtime_1.jsx)(DialogTitle_1.default, { children: "\u91CD\u8A2D\u5BC6\u78BC" }), (0, jsx_runtime_1.jsx)(DialogContent_1.default, { children: (0, jsx_runtime_1.jsx)(TextField_1.default, { label: "\u65B0\u5BC6\u78BC", type: "password", value: resetPwd, onChange: e => setResetPwd(e.target.value), error: !!resetPwdError, helperText: resetPwdError || '密碼至少6碼，需包含英文與數字', fullWidth: true, required: true }) }), (0, jsx_runtime_1.jsxs)(DialogActions_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Button, { onClick: handleCloseResetPwd, children: "\u53D6\u6D88" }), (0, jsx_runtime_1.jsx)(material_1.Button, { onClick: handleResetPwd, variant: "contained", children: "\u5132\u5B58" })] })] }), (0, jsx_runtime_1.jsxs)(Dialog_1.default, { open: viewPwdDialogOpen, onClose: handleCloseViewPwd, children: [(0, jsx_runtime_1.jsx)(DialogTitle_1.default, { children: "\u67E5\u8A62\u5BC6\u78BC" }), (0, jsx_runtime_1.jsxs)(DialogContent_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Box, { sx: { mb: 2 }, children: (0, jsx_runtime_1.jsxs)(material_1.Typography, { variant: "body2", color: "text.secondary", children: ["\u6703\u54E1\uFF1A", viewPwdUser === null || viewPwdUser === void 0 ? void 0 : viewPwdUser.name, " (", viewPwdUser === null || viewPwdUser === void 0 ? void 0 : viewPwdUser.username, ")"] }) }), (0, jsx_runtime_1.jsx)(TextField_1.default, { label: "\u5BC6\u78BC", type: "text", value: viewPwd, InputProps: {
                                    readOnly: true,
                                }, fullWidth: true, placeholder: viewPwdLoading ? '載入中...' : '點擊查詢按鈕查看密碼' })] }), (0, jsx_runtime_1.jsxs)(DialogActions_1.default, { children: [(0, jsx_runtime_1.jsx)(material_1.Button, { onClick: handleCloseViewPwd, children: "\u95DC\u9589" }), (0, jsx_runtime_1.jsx)(material_1.Button, { onClick: handleViewPwd, variant: "contained", disabled: viewPwdLoading, startIcon: viewPwdLoading ? (0, jsx_runtime_1.jsx)(material_1.CircularProgress, { size: 16 }) : null, children: viewPwdLoading ? '查詢中...' : '查詢密碼' })] })] })] }));
};
