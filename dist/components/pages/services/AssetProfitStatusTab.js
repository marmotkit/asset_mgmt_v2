...
const AssetProfitStatusTab = () => {
    ...
    const loadData = async () => {
        ...
        try {
            ...
            const [investmentsData, membersData] = await Promise.all([
                ...
                services_1.ApiService.getMembers()
            ]);
            ...
            if (isAdmin || isManager) {
                // 管理員和管理者可以看到全部資料
                profitsData = await services_1.ApiService.getMemberProfits(undefined, undefined, yearFilter, showAllYear ? undefined : monthFilter);
            }
            else {
                // 一般會員只能看到自己的分潤資料
                profitsData = await services_1.ApiService.getMemberProfits(undefined, user === null || user === void 0 ? void 0 : user.id, // 只查詢當前用戶的分潤
                yearFilter, showAllYear ? undefined : monthFilter);
            }
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { mb: 2, display: 'flex', justifyContent: 'space-between', alignItems: 'center' }, children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h6", children: "\u8CC7\u7522\u5206\u6F64\u72C0\u6CC1" }), (0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.FormControl, { sx: { mr: 2, minWidth: 100 }, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { id: "year-filter-label", children: "\u5E74\u5EA6" }), (0, jsx_runtime_1.jsx)(material_1.Select, { labelId: "year-filter-label", value: yearFilter.toString(), label: "\u5E74\u5EA6", onChange: (e) => setYearFilter(Number(e.target.value)), children: Array.from({ length: 10 }, (_, i) => new Date().getFullYear() - 5 + i).map((year) => ((0, jsx_runtime_1.jsxs)(material_1.MenuItem, { value: year, children: [year, " \u5E74"] }, year))) })] }), !showAllYear && ((0, jsx_runtime_1.jsxs)(material_1.FormControl, { sx: { mr: 2, minWidth: 100 }, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { id: "month-filter-label", children: "\u6708\u4EFD" }), (0, jsx_runtime_1.jsx)(material_1.Select, { labelId: "month-filter-label", value: monthFilter.toString(), label: "\u6708\u4EFD", onChange: (e) => setMonthFilter(Number(e.target.value)), children: Array.from({ length: 12 }, (_, i) => i + 1).map((month) => ((0, jsx_runtime_1.jsxs)(material_1.MenuItem, { value: month, children: [month, " \u6708"] }, month))) })] })), (0, jsx_runtime_1.jsx)(material_1.FormControlLabel, { control: (0, jsx_runtime_1.jsx)(material_1.Checkbox, { checked: showAllYear, onChange: (e) => setShowAllYear(e.target.checked) }), label: "\u7576\u5E74\u5EA6", sx: { mr: 2 } })] })] }), !isAdmin && !isManager && ((0, jsx_runtime_1.jsx)(material_1.Alert, { severity: "info", sx: { mb: 2 }, children: "\u60A8\u53EA\u80FD\u67E5\u770B\u5C6C\u65BC\u81EA\u5DF1\u7684\u8CC7\u7522\u5206\u6F64\u72C0\u6CC1" })), (0, jsx_runtime_1.jsx)(material_1.TableContainer, { component: material_1.Paper, children: (0, jsx_runtime_1.jsxs)(material_1.Table, { children: [(0, jsx_runtime_1.jsx)(material_1.TableHead, { children: (0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getSortLabel('investmentName', '投資項目') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getSortLabel('yearMonth', '年月') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: getSortLabel('amount', '分潤金額') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getSortLabel('status', '收款狀態') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getSortLabel('paymentMethod', '收款方式') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getSortLabel('paymentDate', '收款日期') }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u5099\u8A3B" })] }) }), (0, jsx_runtime_1.jsxs)(material_1.TableBody, { children: [sortProfits(memberProfits).map((profit) => {
                                    const investment = investments.find((inv) => inv.id === profit.investmentId);
                                    const member = members.find((m) => m.id === profit.memberId);
                                    return ((0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: (investment === null || investment === void 0 ? void 0 : investment.name) || '未知項目' }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: `${profit.year}年${profit.month}月` }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: (0, format_1.formatCurrency)(profit.amount) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: (0, jsx_runtime_1.jsx)(material_1.Chip, { label: getStatusText(profit.status), color: getStatusColor(profit.status), size: "small" }) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getPaymentMethodText(profit.paymentMethod) }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: profit.paymentDate ? (0, format_1.formatDate)(profit.paymentDate) : '-' }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: profit.note || '-' })] }, profit.id));
                                }), memberProfits.length === 0 && ((0, jsx_runtime_1.jsx)(material_1.TableRow, { children: (0, jsx_runtime_1.jsx)(material_1.TableCell, { colSpan: 7, align: "center", children: "\u5C1A\u7121\u8CC7\u7522\u5206\u6F64\u8CC7\u6599" }) }))] })] }) })] }));
};
exports.default = AssetProfitStatusTab;
