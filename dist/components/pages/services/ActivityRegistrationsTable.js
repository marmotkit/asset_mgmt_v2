    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (editMode && selectedRegistration) {
                await memberServiceAPI_1.MemberServiceAPI.updateRegistration(selectedRegistration.id, registrationForm);
