...
const PayablesTab = () => {
    ...
    const loadPayables = async () => {
        setLoading(true);
        try {
            const data = await accounting_service_1.accountingService.getPayables();
            setPayables(data);
        }
        catch (error) {
    ...
    const filteredPayables = payables.filter(payable => {
        ...
        return (payable.vendorName.toLowerCase().includes(searchLower) ||
    ...
    const handleSubmit = async () => {
        ...
        try {
            if (editingPayable) {
                // 更新記錄
                const updatedPayable = await accounting_service_1.accountingService.updatePayable(editingPayable.id, formData);
                ...
                // 新增記錄
                const newPayable = await accounting_service_1.accountingService.addPayable({
                    ...formData,
                    paidAmount: 0,
                    status: 'pending'
                });
    ...
    const handlePaymentSubmit = async () => {
        ...
        try {
            ...
            // 這裡也可以添加會計記錄功能，記錄支出
            const updatedPayable = await accounting_service_1.accountingService.updatePayable(editingPayable.id, {
    ...
    const handleDeleteConfirm = async () => {
        if (!payableToDelete)
            return;
        try {
            const success = await accounting_service_1.accountingService.deletePayable(payableToDelete);
            if (success) {
    ...
    return ((0, jsx_runtime_1.jsxs)(material_1.Box, { children: [(0, jsx_runtime_1.jsxs)(material_1.Box, { sx: { display: 'flex', justifyContent: 'space-between', mb: 3 }, children: [(0, jsx_runtime_1.jsx)(material_1.Typography, { variant: "h5", children: "\u61C9\u4ED8\u5E33\u6B3E" }), (0, jsx_runtime_1.jsx)(material_1.Button, { variant: "contained", color: "primary", startIcon: (0, jsx_runtime_1.jsx)(icons_material_1.Add, {}), onClick: () => handleOpenDialog(), children: "\u65B0\u589E\u61C9\u4ED8\u5E33\u6B3E" })] }), (0, jsx_runtime_1.jsx)(material_1.Paper, { sx: { p: 2, mb: 3 }, children: (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, spacing: 2, alignItems: "center", children: [(0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, md: 5, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, placeholder: "\u641C\u5C0B\u4F9B\u61C9\u5546\u3001\u63CF\u8FF0\u6216\u767C\u7968\u865F\u78BC", value: searchTerm, onChange: e => setSearchTerm(e.target.value), InputProps: {
                                ...
                                } }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, md: 3, children: (0, jsx_runtime_1.jsxs)(material_1.FormControl, { fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.InputLabel, { children: "\u72C0\u614B" }), (0, jsx_runtime_1.jsxs)(material_1.Select, { value: filterStatus, onChange: e => setFilterStatus(e.target.value), label: "\u72C0\u614B", children: [(0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: "all", children: "\u5168\u90E8" }), statusOptions.map(status => ((0, jsx_runtime_1.jsx)(material_1.MenuItem, { value: status.value, children: status.label }, status.value)))] })] }) }), (0, jsx_runtime_1.jsxs)(material_1.Grid, { item: true, xs: 12, md: 4, sx: { textAlign: 'right' }, children: [(0, jsx_runtime_1.jsxs)(material_1.Typography, { children: ["\u7E3D\u8A08: ", filteredPayables.reduce((sum, item) => sum + (item.amount - item.paidAmount), 0).toLocaleString(), " \u5143"] }), (0, jsx_runtime_1.jsxs)(material_1.Typography, { children: ["\u5171 ", filteredPayables.length, " \u7B46\u8A18\u9304"] })] })] }) }), loading ? ((0, jsx_runtime_1.jsx)(material_1.Box, { sx: { display: 'flex', justifyContent: 'center', mt: 3 }, children: (0, jsx_runtime_1.jsx)(material_1.CircularProgress, {}) })) : ((0, jsx_runtime_1.jsx)(material_1.TableContainer, { component: material_1.Paper, children: (0, jsx_runtime_1.jsxs)(material_1.Table, { children: [(0, jsx_runtime_1.jsx)(material_1.TableHead, { children: (0, jsx_runtime_1.jsxs)(material_1.TableRow, { children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u4F9B\u61C9\u5546" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u65E5\u671F" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u5230\u671F\u65E5" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u63CF\u8FF0" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: "\u91D1\u984D" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: "\u5DF2\u4ED8\u91D1\u984D" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: "\u9918\u984D" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: "\u72C0\u614B" }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: "\u64CD\u4F5C" })] }) }), (0, jsx_runtime_1.jsx)(material_1.TableBody, { children: filteredPayables.length === 0 ? ((0, jsx_runtime_1.jsx)(material_1.TableRow, { children: (0, jsx_runtime_1.jsx)(material_1.TableCell, { colSpan: 9, align: "center", children: "\u7121\u7B26\u5408\u689D\u4EF6\u7684\u61C9\u4ED8\u5E33\u6B3E" }) })) : (filteredPayables.map(payable => {
                                const age = calculateAge(payable.dueDate);
                                const balance = payable.amount - payable.paidAmount;
                                return ((0, jsx_runtime_1.jsxs)(material_1.TableRow, { sx: age > 0 && payable.status !== 'paid' ? { bgcolor: 'rgba(255, 0, 0, 0.05)' } : {}, children: [(0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payable.vendorName }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payable.date }), (0, jsx_runtime_1.jsxs)(material_1.TableCell, { children: [payable.dueDate, age > 0 && payable.status !== 'paid' && ((0, jsx_runtime_1.jsxs)(material_1.Typography, { variant: "caption", color: "error", component: "div", children: ["\u903E\u671F ", age, " \u5929"] }))] }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: payable.description }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: payable.amount.toLocaleString() }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", children: payable.paidAmount.toLocaleString() }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { align: "right", sx: {
                                                fontWeight: 'bold',
                                                color: balance > 0 ? 'error.main' : 'success.main'
                                            }, children: balance.toLocaleString() }), (0, jsx_runtime_1.jsx)(material_1.TableCell, { children: getStatusChip(payable.status) }), (0, jsx_runtime_1.jsxs)(material_1.TableCell, { align: "right", children: [balance > 0 && ((0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", color: "success", onClick: () => handleOpenPaymentDialog(payable), title: "\u57F7\u884C\u4ED8\u6B3E", children: (0, jsx_runtime_1.jsx)(icons_material_1.Payment, {}) })), (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", color: "primary", onClick: () => handleOpenDialog(payable), title: "\u7DE8\u8F2F", children: (0, jsx_runtime_1.jsx)(icons_material_1.Edit, {}) }), (0, jsx_runtime_1.jsx)(material_1.IconButton, { size: "small", color: "error", onClick: () => handleDeleteClick(payable.id), title: "\u522A\u9664", children: (0, jsx_runtime_1.jsx)(icons_material_1.Delete, {}) })] })] }, payable.id));
                            })) })] }) })), (0, jsx_runtime_1.jsxs)(material_1.Dialog, { open: dialogOpen, onClose: handleCloseDialog, maxWidth: "md", fullWidth: true, children: [(0, jsx_runtime_1.jsx)(material_1.DialogTitle, { children: editingPayable ? '編輯應付帳款' : '新增應付帳款' }), (0, jsx_runtime_1.jsx)(material_1.DialogContent, { dividers: true, children: (0, jsx_runtime_1.jsxs)(material_1.Grid, { container: true, spacing: 2, children: [(0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, md: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u4F9B\u61C9\u5546\u540D\u7A31", value: formData.vendorName, onChange: e => handleFormChange('vendorName', e.target.value), margin: "normal", error: !!formErrors.vendorName, helperText: formErrors.vendorName }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, md: 6, children: (0, jsx_runtime_1.jsx)(material_1.TextField, { fullWidth: true, label: "\u767C\u7968\u865F\u78BC", value: formData.invoiceNumber, onChange: e => handleFormChange('invoiceNumber', e.target.value), margin: "normal", placeholder: "\u9078\u586B" }) }), (0, jsx_runtime_1.jsx)(material_1.Grid, { item: true, xs: 12, md: 6, children: (0, jsx_runtime_1.jsx)(LocalizationProvider_1.LocalizationProvider, { dateAdapter: AdapterDayjs_1.AdapterDayjs, children: (0, jsx_runtime_1.jsx)(DatePicker_1.DatePicker, { label: "\u5EFA\u7ACB\u65E5\u671F", value: (0, dayjs_1.default)(formData.date), onChange: (value) => handleFormChange('date', value ? value.format('YYYY-MM-DD') : ''), format: "YYYY/MM/DD", slotProps: {
                                                textField: {
                                                    fullWidth: true,
                                                    margin: 'normal',
