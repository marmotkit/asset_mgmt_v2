...
exports.accountingService = {
    ...
    updateAccountRecord: async (id, record) => {
        await new Promise(resolve => setTimeout(resolve, 500));
    ...
    updateReceivable: async (id, receivable) => {
        await new Promise(resolve => setTimeout(resolve, 500));
    ...
    getMonthlyClosingDetail: async (id) => {
        await new Promise(resolve => setTimeout(resolve, 300));
    ...
    createMonthlyClosing: async (data) => {
        ...
        // 檢查是否已存在
        const exists = monthlyClosings.some(closing => closing.year === data.year && closing.month === data.month);
        if (exists) {
    ...
    finalizeMonthlyClosing: async (id) => {
        await new Promise(resolve => setTimeout(resolve, 500));
