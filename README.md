...
### V6.8.0 (2025-01-27)
- 實現異常記錄完整功能：建立 anomalies 資料表並支援完整 CRUD 操作
- 建立異常記錄 API 路由：`/api/anomalies` 支援新增、查詢、更新、刪除
- 更新風險管理功能：其他異常記錄從 localStorage 改為真實資料庫連接
- 修正前端組件：欄位名稱統一（occurrenceDate, handlingMethod）
- 新增異常記錄類型：繳款問題、合約爭議、遺失資料、系統錯誤、其他
